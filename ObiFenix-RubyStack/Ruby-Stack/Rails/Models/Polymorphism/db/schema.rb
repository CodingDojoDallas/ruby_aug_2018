...
ActiveRecord::Schema.define(version: 20180804224501) do
  ...
  add_index "messsages", ["post_id"], name: "index_messsages_on_post_id"
  add_index "messsages", ["user_id"], name: "index_messsages_on_user_id"
